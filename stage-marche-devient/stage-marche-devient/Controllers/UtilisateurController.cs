using MarcheEtDevient.Server.Data                           /* Importe le namespace contenant la classe ApiDBContext
                                                             * utilisée pour interagir avec la base de données*/
using MarcheEtDevient.Server.Models;                        /*  Importe le namespace contenant le modèle Utilisateur*/
using MarcheEtDevient.Server.Repository;                    /*Importe le namespace contenant le repository UtilisateurRepository*/
                                                             ...
                                                             * Cela aide à organiser le code*/
{
    ...
    public class UtilisateursController : ControllerBase    /*Déclare la classe UtilisateursController qui hérite de ControllerBase
                                                            * la classe de base pour les contrôleurs API dans ASP.NET Core*/
    {
        ...
        public UtilisateursController(ApiDBContext context) /*Constructeur de la classe UtilisateursController
        ...
        public async Task<ActionResult<IEnumerable<Utilisateur>>> GetAllUtilisateurs() /*Déclare une méthode asynchrone qui retourne une liste de tous les utilisateurs 
        ...
        public async Task<ActionResult<Utilisateur>> GetUtilisateur(int id) /*Déclare une méthode asynchrone qui retourne un utilisateur spécifique par son ID*/
        {
        ...
        public async Task<IActionResult> UpdateUtilisateur(int id, Utilisateur utilisateur) /*Déclare une méthode asynchrone qui met à jour un utilisateur existant*/
        {
        ...
        public async Task<IActionResult> DeleteUtilisateur(int id) /*Déclare une méthode asynchrone qui supprime un utilisateur existant*/
        {
